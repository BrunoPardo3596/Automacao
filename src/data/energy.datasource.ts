      ...
      datasets: [
        {
          ...
          data: [data[0].dados[0].gasto, data[1].dados[0].gasto, data[2].dados[0].gasto, data[3].dados[0].gasto,
            data[4].dados[0].gasto, data[5].dados[0].gasto, data[6].dados[0].gasto, data[7].dados[0].gasto, data[8].dados[0].gasto, 0,
      ...
      datasets: [
        {
          ...
          pointHighlightStroke: "rgba(220,220,220,1)",
          xAxisID: 'Months',
          data: [0, data[0].dados[0].gasto, data[1].dados[0].gasto, data[2].dados[0].gasto, 0, 0, 0, 0, 0, 0, 0, ]
        },
      ]
    }
  }
